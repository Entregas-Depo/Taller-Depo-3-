...
public class PersistenciaTiquetesJson implements IPersistenciaTiquetes
{
     ...
     */
    @Override
    public void salvarTiquetes( String archivo, Aerolinea aerolinea ) throws Throwable
    {
     ...
     * @throws Throwable 
     */
    private void salvarClientes( Aerolinea aerolinea, JSONObject jobject ) throws Throwable
    {
    ...
    private void salvarTiquetes( Aerolinea aerolinea, JSONObject jobject )
    {
        ...
        for( Tiquete tiquete : aerolinea.getTiquetes( ) )
        {
            ...
            tiquete.getVuelo( ).getRuta( );
			JSONObject jsonObject = new JSONObject();
			jsonObject.put(CODIGO_RUTA, Ruta.getCodigoRuta( ));
